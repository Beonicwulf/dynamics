...
public class DynamicsDistribution {
    ...
    public static void load() {
        accelerator = new MassDriver("accelerator"){{
            requirements(Category.distribution, with(DynamicsItems.zinc, 10, DynamicsItems.malachite, 5));
            size = 1;
            itemCapacity = 10;
            hasPower = false;
            range = 60;
            ...
            researchCost = with(DynamicsItems.zinc, 10 * 5, DynamicsItems.malachite, 5 * 5);
        }};
