...
public class IconLoader{
    public static void loadIcons(){
        ...
        try(Reader reader = Vars.tree.get("icons/dy-icons.properties").reader(512)){
...
// thanks, Stabu_
// source:  https://github.com/stabu-dev/Omaloon/blob/master/src/omaloon/utils/IconLoader.java