package dynamics.world.blocks.crafting;
...
public class RecipeCrafter extends Block {
    ...
    public void setStats() {
        ...
        stats.add(DynamicsStat.recipes, table -> {
            table.row();
...
// Thanks, Nullotte!
// Source: https://github.com/nullotte/Carpe-Diem/blob/main/src/carpediem/world/blocks/crafting/RecipeCrafter.java